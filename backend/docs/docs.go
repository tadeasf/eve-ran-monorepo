    ...
    "paths": {
        ...
        "/characters/batch": {
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "description": "Array of character IDs to delete",
                        "name": "characters",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.KillComment"
                        }
                    }
                ],
                "responses": {
        ...
        "/kills": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Filter by victim ship type ID",
                        "name": "ship_type_id",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        ...
        "models.KillComment": {
            ...
            "properties": {
                ...
                "user_id": {
                    "description": "For future user management",
                    "type": "integer"
                },
                "username": {
                    "type": "string"
