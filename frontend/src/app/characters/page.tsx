...
import { BatchCharacterManager } from '@/app/components/BatchCharacterManager'
    ...
    <div className="p-8 space-y-6">
      ...
      <Tabs defaultValue="existing" className="space-y-6">
        ...
        <TabsContent value="existing" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage characters currently in your database
              </CardDescription>
            </CardHeader>
            <CardContent>
              {isLoading ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-sm text-muted-foreground">Add some characters using the Search & Add or Batch Management tabs</p>
                </div>
              ) : (
        ...
        <TabsContent value="batch" className="space-y-6">
          <BatchCharacterManager 
            onBatchComplete={() => {
              // Refresh the character list after batch operations
              fetchCharacters()
            }}
          />
        </TabsContent>
